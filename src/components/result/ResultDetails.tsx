...
import { Clock, Video, Image as ImageIcon, AlertTriangle, Shield, Info } from "lucide-react";
...
const ResultDetails = ({ result }: ResultDetailsProps) => {
  const { 
    detectionType = 'image', 
    frameCount, 
    processingTime, 
  ...
  // Safely access metadata or provide empty object as fallback
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col space-y-2 text-sm text-muted-foreground mt-2">
        <div className="flex items-center">
          ...
          <span>Content type: <span className="font-medium capitalize">{detectionType}</span></span>
        </div>
